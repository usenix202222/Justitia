...
as the test input to verify the installation of Justitia. These contracts are 
in the folder Justitia/src/synthesis/test/test_template/test_case/. 
Smart contracts generated by Justitia are also in the same folder.
